...
from const import C_YELLOW, SCORE_POS, MENU_OPTION, COLOR_WHITE
...
class Score:
    ...
    def show(self):
       ...
       for player_score in list_score:
           ...
           self.score_text(text_size=20, text=f'{name} {score:05d} {date}', text_color=C_YELLOW, text_center_pos= SCORE_POS[list_score.index(player_score)])
       while True:
           for event in pygame.event.get():
               if event.type == pygame.QUIT:
                   pygame.quit()
